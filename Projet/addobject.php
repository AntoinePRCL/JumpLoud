...
<div class="container-fluid">
	<div class="row justify-content-center">
		<div class="col-lg-8">
			...
			if (isset($_SESSION['addObject'])) {
				if ($_SESSION['addObject']['etat'] == "NOK") {
					...
					<div class='text-center'>
						...
						<p>Vous pouvez consulter son statut dans la rubrique <a href='lendObject.php'>\"Mes évènements\"</a></p>
					</div>
					";
					$etat = "Succès";
				}
			...
			?>
			<h1 class="titleUnderlined">Ajouter un évènement</h1>
			<div class="jumbotron">
				<div class="row justify-content-center">
					<div class="col-lg-8">
						<form method="POST" action="script/script_addobject.php" enctype="multipart/form-data">
							...
							<div class="form-row">
								<div class="form-group col-md-12">
									...
									<input value="<?php if(isset($_POST['designation'])){ echo $_POST['designation'];}?>" type="text" id="1" class="form-control" placeholder="Nom de votre évènement" name="designation">
								</div>						
							</div>
							<div class="form-row">
								<div class="form-group col-md-12">
									<label for="2">Description</label>
									<textarea style="resize: none; height:12vh" id="2" placeholder="Décrivez votre évènement" class="form-control" name="description"><?php if(isset($_POST['description'])){ echo $_POST['description'];}?></textarea>
								</div>	
							</div>
							<div class="form-row">
								<div class="form-group col-md-12">
									<label for="3">Début de l'évènement (date du jour si bon plan)</label>
							...
							<div class="form-row justify-content-center">
								<div class="form-group">
									<input type="submit" value="Ajouter mon évènement" class="btn btn-success">
								</div>
							</div>
						</form>
					</div>
