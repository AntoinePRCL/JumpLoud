...
<div class="container-fluid">
	<div class="row justify-content-center">
		<div class="col-lg-8">
			<h1 class="titleUnderlined">Rechercher un évènement</h1>
			<div class="jumbotron">
				<div class="row justify-content-center">
				...
				if (isset($_POST['search'])) {
						...
						<div class="col-lg-11">
							...
							if ($_POST['categorie'] == 'all') {
								$recherche = $bdd->query('SELECT * FROM produit 
									WHERE nom_objet LIKE "%'.$_POST['search'].'%" OR description LIKE "%'.$_POST['search'].'%"
									AND approbation="1" AND lent=0');
					...
					<div class="row justify-content-center">
						...
						<div class="col-lg-11">
							<?php
							$annonces = $bdd->query('SELECT * FROM produit WHERE type="pret" AND approbation="1" AND lent=0 ORDER BY dateHeure DESC LIMIT 0,5');
